...
--------------- Gramatica: -------------------------------------------------
-- irudia
-- MOZKETA BIRAKETA ISLAPENA LEKU_ALDATZEA ID ESLEI P_Z P_X P_Y P_B P_C P_D P_F P_G P_H ZENB P_IRE P_ITXI P_COMA G_IRE G_ITXI 
...
--aldaketa -> LEKU_ALDATZEA ardatza ZENB
--ardatza -> P_X
--ardatza -> P_Y
--ardatza -> P_Z
--elementua -> P_B
...
tabla_acc=(Elem_acc {estado=1,term="ID",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=4}):
       ...
       (Elem_acc {estado=28,term="MOZKETA",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=33}):
       (Elem_acc {estado=28,term="BIRAKETA",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=32}):
       (Elem_acc {estado=28,term="ISLAPENA",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=31}):
       (Elem_acc {estado=28,term="LEKU_ALDATZEA",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=30}):
       (Elem_acc {estado=29,term="$",accion="reducir",regla=(PIzda "transformatu",Pdcha ["ID","ESLEI","ID","aldaketa_segida"]), sig_estado=0}):
       (Elem_acc {estado=30,term="P_X",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=44}):
       (Elem_acc {estado=30,term="P_Y",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=43}):
       (Elem_acc {estado=30,term="P_Z",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=45}):
       ...
       (Elem_acc {estado=48,term="ZENB",accion="desplazar",regla=(PIzda "A",Pdcha ["lambda"]), sig_estado=49}):
       (Elem_acc {estado=49,term="MOZKETA",accion="reducir",regla=(PIzda "aldaketa",Pdcha ["LEKU_ALDATZEA","ardatza","ZENB"]), sig_estado=0}):
       (Elem_acc {estado=49,term="BIRAKETA",accion="reducir",regla=(PIzda "aldaketa",Pdcha ["LEKU_ALDATZEA","ardatza","ZENB"]), sig_estado=0}):
       (Elem_acc {estado=49,term="ISLAPENA",accion="reducir",regla=(PIzda "aldaketa",Pdcha ["LEKU_ALDATZEA","ardatza","ZENB"]), sig_estado=0}):
       (Elem_acc {estado=49,term="LEKU_ALDATZEA",accion="reducir",regla=(PIzda "aldaketa",Pdcha ["LEKU_ALDATZEA","ardatza","ZENB"]), sig_estado=0}):
       (Elem_acc {estado=49,term="$",accion="reducir",regla=(PIzda "aldaketa",Pdcha ["LEKU_ALDATZEA","ardatza","ZENB"]), sig_estado=0}):
       (Elem_acc {estado=50,term="$",accion="reducir",regla=(PIzda "aldaketa_segida",Pdcha ["aldaketa","aldaketa_segida"]), sig_estado=0}):
       []
...
tabla_ira=(Elem_ira {estado2=1,var="irudia",sig_estado2=3}):
       ...
       (Elem_ira {estado2=28,var="aldaketa_segida",sig_estado2=50}):
       (Elem_ira {estado2=28,var="aldaketa",sig_estado2=28}):
       (Elem_ira {estado2=30,var="ardatza",sig_estado2=48}):
...
axioma="Pirudia"
terminales::[String]
terminales = ["MOZKETA","BIRAKETA","ISLAPENA","LEKU_ALDATZEA","ID","ESLEI","P_Z","P_X","P_Y","P_B","P_C","P_D","P_F","P_G","P_H","ZENB","P_IRE","P_ITXI","P_COMA","G_IRE","G_ITXI"]
